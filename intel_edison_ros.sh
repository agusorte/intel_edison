...
rosinstall_generator ros_comm myahrs_driver mavros velodyne_msg velodyne_driver --rosdistro indigo --deps --wet-only --exclude roslisp --tar > indigo-ros_comm-wet.rosinstall
